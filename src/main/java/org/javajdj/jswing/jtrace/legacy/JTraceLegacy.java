 ...
 * 
 */
package org.javajdj.jswing.jtrace.legacy;
...
import org.javajdj.jswing.jtrace.TraceEntry;
  ...
  extends JPanel
{
  ...
  private static final Logger LOG = Logger.getLogger (JTraceLegacy.class.getName ());
  ...
  private final static int X_MARGIN = 6;
  
  private final static int Y_MARGIN = 6;
  ...
  private static final Color GRATICULE_COLOR = Color.green.darker ();
  ...
  private final MouseAdapter mouseAdapter = new MouseAdapter ()
  {
    ...
    {
      JTraceLegacy.this.drawCrossHair = false;
      JTraceLegacy.this.repaint ();
    }

    @Override
    public void mouseEntered (final MouseEvent e)
    {
      JTraceLegacy.this.mouseX = e.getX ();
      JTraceLegacy.this.mouseY = e.getY ();
      JTraceLegacy.this.drawCrossHair = true;
      JTraceLegacy.this.repaint ();
    }
